...
public:
	...
	BEGIN_MSG_MAP(CProgDlg)
		...
		COMMAND_HANDLER(IDC_EDIT_ICON_FILE, EN_CHANGE, OnEnChangeEditIconFile)
	...
	LRESULT OnEnChangeEditIconFile(WORD /*wNotifyCode*/, WORD /*wID*/, HWND /*hWndCtl*/, BOOL& /*bHandled*/);
